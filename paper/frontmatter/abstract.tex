...
synchronisation, and a compile-time soundness gate, so that --- for the restricted
class of nets the language produces --- boundedness and
...
The implementation drives twenty-eight worked examples through ten backends
