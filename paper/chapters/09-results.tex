...
Every number below is drawn from the live toolchain.
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}llr@{}}
    ...
    \texttt{openmp-rs}        & tier-1 (work-stealing pool)    & 444 \\
  ...
  individual tier-1 backends are small, the thinnest under two hundred lines.}
...
\begin{table}[t]
  ...
  spread across several heterogeneous convolution and pooling loops rather than a
  single dominant loop volume.}
  \label{tab:quant-net}
\end{table}
