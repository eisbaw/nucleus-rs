...
for instance by accumulating into a wide fixed-point superaccumulator --- an integer
accumulator wide enough to represent any partial sum exactly --- that absorbs
each addend without rounding, or by pre-rounding addends to a common granularity, so that the
