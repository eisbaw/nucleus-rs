...
quantitative study --- each of which would widen the audience or sharpen the
evidence, and the discipline that
shaped the original design --- lift a limit only while keeping the soundness gate
sound and the differential test meaningful --- is the constraint under which that
widening must happen.
