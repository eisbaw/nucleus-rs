...
This chapter introduces the concepts the rest of the dissertation depends on. It
...
discipline that the algorithm never mentions the schedule. This dissertation
...
the cost of run-time overhead, nondeterminism, and analyses that can only be
...
precisely to remove run-time overhead --- and this work sits firmly in that
