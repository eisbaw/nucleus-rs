...
<!-- SECTION:NOTES:BEGIN -->
M5 AC#3 closure: TASK-0267 (BUG 1, cycle 101) + TASK-0268 (BUG 2, cycle 102) both landed. 05-stencil/distributed × pthreads-async + × mp-tcp-event both PROMOTED to [[required]] M5, bit-identical to reference.bin. e2e baseline advanced from 92/77/0/15/0 (pre-TASK-0267) to 92/79/0/13/0 (post-TASK-0268). The umbrella's promotion target is met. Cell stays unblocked across the partition=rows + async + buffer + notify=event + reuse + halo synthesis pipeline.
<!-- SECTION:NOTES:END -->
